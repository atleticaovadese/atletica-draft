...
- [x] **2025–2012 COMPLETI** — tutti i 20 eventi (M+F) per ogni stagione, ~1800–2000 carte/anno
- [ ] 2011, 2010, … a ritroso (i dati WA sono ricchi dal ~2001, più radi prima)

Carte totali attuali: **~27.500** (BASE 308 + shard 2025→2012). Procedura in `CLAUDE.md`.
Mondiale: 14 anni sorteggiabili (2012–2025).
