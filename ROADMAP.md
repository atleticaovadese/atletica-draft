...
- [x] **2025–2013 COMPLETI** — tutti i 20 eventi (M+F) per ogni stagione, ~1800–2000 carte/anno
- [ ] 2012, 2011, … a ritroso (i dati WA sono ricchi dal ~2001, più radi prima)

Carte totali attuali: **~25.500** (BASE 308 + shard 2025→2013). Procedura in `CLAUDE.md`.
Mondiale: 13 anni sorteggiabili (2013–2025).
